...
class HangmanGame {
    ...
    newGame(msg) {
        ...
        this.inGame = true;
        this.word = possible_words[Math.floor(Math.random() * possible_words.length)].toUpperCase(); //randomWords() //***Old code before I added the random words API**
        this.guesssed = [];
        this.wrongs = 0;
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField('How To Play', "React to this message using the emojis that look like letters. The easiest way to do this is to right click select add reaction type a letter and pick the most like emojii. (🅰️, 🇹, ) ")
            .setTimestamp();
